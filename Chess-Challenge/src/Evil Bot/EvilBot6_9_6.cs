...
public class EvilBot6_9_6 : IChessBot
{
    public EvilBot6_9_6()
    {
        for (int i = 0; i < 64; i++)
    ...
    public int Evaluate()
    {
        ...
        middleGame = (middleGame * phase + endGame * (24 - phase) + 384) / (board.IsWhiteToMove ? 24 : -24);
        return middleGame > 0 && phase < 8 ? middleGame - kingDist : middleGame;
    }
