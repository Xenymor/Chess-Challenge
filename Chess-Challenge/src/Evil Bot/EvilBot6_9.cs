...
namespace Chess_Challenge.src.EvilBot6_9
{
    public class EvilBot6_9 : IChessBot
    {
...
#if DEBUG
            Console.WriteLine("EvilBot: " + EvalToString(eval / -100f) + ";\tDepth: " + calculatedDepth + ";\tNodeCount: " + nodeCounter + ";\tNpS: " + (nodeCounter / (float)timer.MillisecondsElapsedThisTurn)); //#DEBUG
