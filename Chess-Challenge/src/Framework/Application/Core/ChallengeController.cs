using Chess_Challenge.src.EvilBot6_2;
using Chess_Challenge.src.EvilBot6_4;
...
namespace ChessChallenge.Application
{
    public class ChallengeController
    {
        ...
        public void StartNewGame(PlayerType whiteType, PlayerType blackType)
        {
            ...
            //board.LoadPosition("8/2r3p1/4Rp2/2p4p/2P3kP/1P6/PK6/8 w - - 0 42");
        ...
        ChessPlayer CreatePlayer(PlayerType type)
        {
            return type switch
            {
                ...
                PlayerType.EvilBot => new ChessPlayer(new EvilBot6_4(), type, GameDurationMilliseconds),
