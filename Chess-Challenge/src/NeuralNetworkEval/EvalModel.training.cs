    ...
    public partial class EvalModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new[] { new InputOutputColumnPair(@"col1", @"col1"), new InputOutputColumnPair(@"col2", @"col2"), new InputOutputColumnPair(@"col3", @"col3"), new InputOutputColumnPair(@"col4", @"col4"), new InputOutputColumnPair(@"col5", @"col5"), new InputOutputColumnPair(@"col6", @"col6"), new InputOutputColumnPair(@"col7", @"col7"), new InputOutputColumnPair(@"col8", @"col8"), new InputOutputColumnPair(@"col9", @"col9"), new InputOutputColumnPair(@"col10", @"col10"), new InputOutputColumnPair(@"col11", @"col11"), new InputOutputColumnPair(@"col12", @"col12"), new InputOutputColumnPair(@"col13", @"col13"), new InputOutputColumnPair(@"col14", @"col14"), new InputOutputColumnPair(@"col15", @"col15"), new InputOutputColumnPair(@"col16", @"col16"), new InputOutputColumnPair(@"col17", @"col17"), new InputOutputColumnPair(@"col18", @"col18"), new InputOutputColumnPair(@"col19", @"col19"), new InputOutputColumnPair(@"col20", @"col20"), new InputOutputColumnPair(@"col21", @"col21"), new InputOutputColumnPair(@"col22", @"col22"), new InputOutputColumnPair(@"col23", @"col23"), new InputOutputColumnPair(@"col24", @"col24"), new InputOutputColumnPair(@"col25", @"col25"), new InputOutputColumnPair(@"col26", @"col26"), new InputOutputColumnPair(@"col27", @"col27"), new InputOutputColumnPair(@"col28", @"col28"), new InputOutputColumnPair(@"col29", @"col29"), new InputOutputColumnPair(@"col30", @"col30"), new InputOutputColumnPair(@"col31", @"col31"), new InputOutputColumnPair(@"col32", @"col32"), new InputOutputColumnPair(@"col33", @"col33"), new InputOutputColumnPair(@"col34", @"col34"), new InputOutputColumnPair(@"col35", @"col35"), new InputOutputColumnPair(@"col36", @"col36"), new InputOutputColumnPair(@"col37", @"col37"), new InputOutputColumnPair(@"col38", @"col38"), new InputOutputColumnPair(@"col39", @"col39"), new InputOutputColumnPair(@"col40", @"col40"), new InputOutputColumnPair(@"col41", @"col41"), new InputOutputColumnPair(@"col42", @"col42"), new InputOutputColumnPair(@"col43", @"col43"), new InputOutputColumnPair(@"col44", @"col44"), new InputOutputColumnPair(@"col45", @"col45"), new InputOutputColumnPair(@"col46", @"col46"), new InputOutputColumnPair(@"col47", @"col47"), new InputOutputColumnPair(@"col48", @"col48"), new InputOutputColumnPair(@"col49", @"col49"), new InputOutputColumnPair(@"col50", @"col50"), new InputOutputColumnPair(@"col51", @"col51"), new InputOutputColumnPair(@"col52", @"col52"), new InputOutputColumnPair(@"col53", @"col53"), new InputOutputColumnPair(@"col54", @"col54"), new InputOutputColumnPair(@"col55", @"col55"), new InputOutputColumnPair(@"col56", @"col56"), new InputOutputColumnPair(@"col57", @"col57"), new InputOutputColumnPair(@"col58", @"col58"), new InputOutputColumnPair(@"col59", @"col59"), new InputOutputColumnPair(@"col60", @"col60"), new InputOutputColumnPair(@"col61", @"col61"), new InputOutputColumnPair(@"col62", @"col62"), new InputOutputColumnPair(@"col63", @"col63"), new InputOutputColumnPair(@"col64", @"col64") })
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options() { NumberOfLeaves = 27, MinimumExampleCountPerLeaf = 57, NumberOfTrees = 1936, MaximumBinCountPerFeature = 89, FeatureFraction = 0.99999999, LearningRate = 0.0250967979750392, LabelColumnName = @"col0", FeatureColumnName = @"Features", DiskTranspose = false }));
