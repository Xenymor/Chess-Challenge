...
cutechess_cli_path = 'C:/Users/timon/Documents/Programmieren/C#/Chess-Challenge/chessScript.02/cutechess-cli.exe'

# The engine whose parameters will be optimized
engine = 'cmd=C:/Users/timon/Documents/Programmieren/C#/Chess-Challenge/MyConsoleBot/bin/Release/net6.0/MyConsoleBot.exe name=\"MyBot\"'
...
opponents = [
    'cmd=C:/Users/timon/Documents/Programmieren/C#/Chess-Challenge/ConsoleBot/bin/Release/net6.0/ConsoleBot.exe name=\"EvilBot\"'
]

# Additional cutechess-cli options, eg. time control and opening book
options = '-each tc=500/60 proto=uci -draw movenumber=80 movecount=5 score=5 -openings file=C:/Users/timon/Documents/Programmieren/C#/Chess-Challenge/SPSA-Tuning/PGN/lichess_db_standard_rated_2013-01.pgn format=pgn order=random plies=5 policy=encounter'
